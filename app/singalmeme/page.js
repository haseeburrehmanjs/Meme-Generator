...
const SingalMeme = (searchParam) => {
    ...
    return (
        <div className='container mx-auto'>
            <h1 className='text-4xl justify-center  items-center h-[70vh] flex flex-col mt-10 font-bold'>
            <h1 className='text-center mt-10 text-6xl font-bold'>Meme Generator</h1>
                ...
                <div className='mt-4'>
                    {myMeme ? <div>
                        <h1>Download <a target='blank' className='text-blue-700 underline' href={myMeme}>Meme</a></h1>
                    </div> : <form className='flex flex-col gap-1' onSubmit={generateMeme}>
